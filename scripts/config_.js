require.config({
    ...
    paths: {
		...
		'flexSlider':['plugins/flexSlider/jquery.flexslider'],
...
window.shell = null;
(function (){
	require(["Shell","util", "owlc", "cookies", "modulevars", "scodata", "apiwrapper", "scoapiwrapper", "lightslider",  "flexSlider", "niceScroll", "progressbar"],function(Shell){
		//flowplayerLoaded();
